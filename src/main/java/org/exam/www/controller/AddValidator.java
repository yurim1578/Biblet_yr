...
//		
//		AdministratorVO admin=(AdministratorVO)target;
//		if(admin.getAdm_email()==null||admin.getAdm_email().trim().isEmpty()) {
//			errors.rejectValue("adm_email", "required");
//		}else {
//			Matcher matcher2=pattern.matcher(admin.getAdm_email());
//			if(!matcher2.matches()) {
//				errors.rejectValue("adm_email","bad");
//			}
//		}
//		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "admin_name", "required");
//		ValidationUtils.rejectIfEmptyOrWhitespace(errors,"adm_id", "required");
//		ValidationUtils.rejectIfEmptyOrWhitespace(errors,"adm_pass", "required");
//	}
//
//	
//	@Override
